  ...
  render(){
    return(
      <div className={`DocumentationPage1`}>
        <blockquote>Ce document ne doit en aucun cas être montré au candidat après l'attribution des points.</blockquote>
        <h2>
        ...
        <h3>Évaluation</h3>
        <p>
          Le/la chef/-e de projet du TPI etles experts/expertes évaluent les compétences professionnelles élargies, le résultat et les compétences professionnelles.
        </p>
        <p>
          L'évaluation du TPI est répartie comme suit :
        </p>
        <ul>
          <li><b>Partie A</b>&thinsp;: Compétences professionnelles (20 critères)
            <ul>
          ...
          <li><b>Partie B</b>&thinsp;: Documentation / rapport du TPI (10 critères)</li>
          <li><b>Partie C</b>&thinsp;: Entretien professionnel et présentation (10 critères)</li>
        </ul>
      </div>
    )
  }
